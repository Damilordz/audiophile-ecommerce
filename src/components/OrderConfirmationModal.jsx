    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      ...
      >
        ...
        <div className="rounded-lg flex flex-col sm:flex-row">
          <div className="sm:w-[60%] bg-[#f1f1f1] sm:p-4 rounded-t-lg sm:rounded-l-lg flex flex-col justify-center">
            {isExpanded ? (
              cartItems.map((item) => (
                <>
          ...
          <div className="bg-black text-white p-4 rounded-b-lg sm:rounded-r-lg flex flex-col justify-center flex-grow gap-2">
