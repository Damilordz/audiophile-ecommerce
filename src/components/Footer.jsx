...
function Footer() {
  return (
    <footer className="bg-black flex justify-center items-center text-center sm:text-start mt-20">
      <div className="w-10/12 flex flex-col items-center sm:items-start">
        ...
        <div className="bg-black flex flex-col flex-grow justify-between  py-10 text-gray-500">
          <div className="grid sm:grid-cols-[50%_40%] gap-8 gap-x-16 justify-between items-center text-white">
            <div className="logo flex items-center justify-center sm:justify-start order-1">
            ...
            <p className="text-[#9b9898] order-3">
            ...
            <div className="socials sm:justify-self-end justify-self-center order-5 sm:order-4">
              {
            ...
            <p className="text-[#9b9898] order-4 sm:order-5">
