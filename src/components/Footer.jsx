...
function Footer() {
  return (
    <footer className="bg-black flex justify-center items-center md:items-start text-center md:text-start mt-20">
      <div className="w-10/12 flex flex-col items-center sm:items-start text-wrap">
        <div className="h-[4px] w-[101px] bg-primary mb-4"></div>
        <div className="bg-black flex flex-col flex-grow justify-between  py-10 text-gray-500">
          <div className="grid md:grid-cols-[60%_30%] lg:grid-cols-[50%_40%] gap-8 gap-x-16 justify-between items-center md:items-start text-white">
            {/* Logo */}
            <div className="logo flex items-center md:items-start justify-center md:col-span-2 lg:col-span-1 md:justify-start order-1">
            ...
            {/* Nav Links */}
            <div className="order-2 md:col-span-2 lg:col-span-1">
              <NavLinks />
            </div>

            <p className="text-[#9b9898] order-3 md:col-span-2 lg:col-span-1">
            ...
            {/* Socials */}
            <div className="socials justify-self-center md:justify-self-end lg:self-end order-5 lg:order-4 md:mt-10 lg:mt-0">
              {
                <ul className="list-none flex gap-4">
                  {socials.map((social) => (
                    <li key={social.name}>
                      ...
                      >
                        <div className="hover:text-primary">{social.icon}</div>
                      </a>
                    </li>
                  ))}
                </ul>
            ...
            <p className="text-[#9b9898] order-4 lg:order-5 md:mt-10 lg:mt-0">
