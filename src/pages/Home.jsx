...
function Home() {
  return (
    <>
      <section className="hero h-[80vh] bg-hero-mobile sm:bg-hero-desktop bg-cover bg-center text-white flex justify-center items-center sm:mb-24 sm:py-32">
        <div className="flex gap-20 w-10/12">
          <div className="flex flex-col gap-8 justify-center items-center text-center sm:items-start max-w-[380px] tracking-widest leading-relaxed">
            <p className="uppercase text-gray-600">NEW PRODUCT</p>
            <h1 className="uppercase font-bold text-[36px] sm:text-[56px] leading-none">
      ...
      <div className="flex justify-center items-center mt-24">
        <div className="w-10/12 flex flex-col gap-10">
          <div className="bg-primary relative rounded-lg h-[600px] sm:h-[560px] py-8 overflow-hidden flex flex-col sm:flex-row gap-10 sm:gap-28 px-7 sm:px-20 items-center justify-center">
            <div className="absolute sm:left-[-150px] sm:bottom-[-350px]">
            ...
            <div className="w-[172px] h-[207px] sm:w-[400px] sm:h-[480px] sm:mb-[-110px] sm:ml-[60px] z-20">
              <img
            ...
            <div className="text-white text-center sm:text-start sm:w-[40%] flex items-center sm:items-start flex-col gap-6 sm:gap-10 z-20">
          ...
          <div className="bg-speaker-2-mobile sm:bg-speaker-2-desktop bg-cover bg-center h-[320px] rounded-lg p-7 sm:px-24 flex flex-col gap-6 justify-center">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-8 rounded-lg">
