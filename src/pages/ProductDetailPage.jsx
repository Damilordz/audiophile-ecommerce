...
const ProductDetails = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-20">
      {product && (
        <div className="w-10/12 flex flex-col gap-20 sm:gap-32 mb-20">
          <div className="flex flex-col sm:flex-row justify-between gap-10 sm:gap-32">
            {/* Responsive Images */}
          ...
          <div className="flex flex-col sm:flex-row gap-6 sm:h-[592px] overflow-hidden">
            <div className="flex flex-col gap-6 sm:w-[40%] h-full">
              {["gallery1", "gallery2"].map((galleryKey, index) => (
                <picture key={index} className="h-full flex-1 overflow-hidden">
                  <source
                    media="(max-width: 768px)"
                    srcSet={
                      product.image.find(
